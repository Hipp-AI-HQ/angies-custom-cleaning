...
<task type="auto">
  ...
  <action>
    ...
    - Selects all .stat__number elements (created in Plan 02)
...
<output>
After completion, create `.planning/phases/02-commercial-site/02-04-SUMMARY.md` documenting JavaScript features added, CountUp.js implementation details, IntersectionObserver usage, and any browser compatibility notes.
</output>
