...
<task type="auto">
  ...
  <action>
Add hamburger button, navigation slide-in, and overlay styles to components.css on BOTH sites. Append after existing button/card hover effects.
...
<task type="auto">
  ...
  <action>
Add mobile menu toggle functionality to main.js on BOTH sites. Append at END of file (after AOS and smooth scroll code from Plan 04-01).
